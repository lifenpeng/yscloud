...
(function(mod) {
    ...
    CodeMirror.defineMode("sql", function(config, parserConfig) {
        ...
        function tokenBase(stream, state) {
            ...
            if (support.hexNumber == true &&
                ...
                if (dangers.hasOwnProperty(word)) return "danger";
                return null;
            }
        }
    ...
    (function() {
        ...
        var sqlKeywords = "alter and as asc between by count create desc distinct drop from group having in into is join like not on or order select set table union values where limit ";
        var sqltestdanger = "delete insert update";
