...
!function ($) {
    ...
    BootstrapTable.LOCALES['en-US'] = {
        formatLoadingMessage: function () {
            return '数据努力加载中, 请耐心等待...';
        },
        formatRecordsPerPage: function (pageNumber) {
            return "";
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf('', pageFrom, pageTo, totalRows);
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            ...
            '<div class="fixed-table-loading" style="color:#44dcfd;padding-top:6px;padding-bottom:24px;background: rgb(23, 26, 35)">',
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        this.$body.find('> tr > td').off('click').on('click', function () {
            ...
            /*
             vision： 2015年12月31日
             copyright：张光毅
             text：表格无内容时，行点击事件报错，未找到行点击事件。
             old vision:value = item[field]
             * */
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        request = $.extend({}, calculateObjectValue(null, this.options.ajaxOptions), {
            ...
            success: function (res) {
                if(request.data.offset == 0) that.options.pageNumber = 1;
